...
![[Pasted image 20231218154433.png]]
...
![[Pasted image 20231218154618.png]]
...
![[Pasted image 20231218154809.png]]
...
![[Pasted image 20231218154933.png]]
...
![[Pasted image 20231218155052.png]]
...
![[Pasted image 20231218155113.png]]
...
![[Pasted image 20231218155146.png]]
...
这里，我的建议是：用其他命令来替代，例如可以用 SCAN 来代替，避免在 Redis 内部产生费时的全集合遍历操作。当然，我们不能忘了复杂度较高的 List 类型，它的两种底层实现结构：双向链表和压缩列表的操作复杂度都是 O(N)。因此，我的建议是：因地制宜地使用 List 类型。例如，既然它的 POP/PUSH 效率很高，那么就将它主要用于 FIFO 队列场景，而不是作为一个可以随机读写的集合。